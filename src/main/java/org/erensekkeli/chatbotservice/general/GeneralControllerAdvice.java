...
public class GeneralControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleNotFoundException(ItemNotFoundException e, WebRequest request) {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleInvalidSessionException(AuthorizationException e, WebRequest request) {
